...
Author: Elvin D.
Description: A simple and lightweight plugin that makes HTML &lt;form&gt; tag to become responsive. After activation, go to Dashboard > Magic Liquidizer Lite > Form.
Version: 1.0.5
	...
	echo '<table class="form-table" style="color: #bbb;">
		...
		echo '</tbody>
 		...
 		public function magic_liquidizer_form_scripts() {    	 	 
    		...
    		add_action('wp_print_footer_scripts', array($this, 'execute_jquery_form_lite'));
